...
<head>
    ...
    /* Mejorar visualización de select */
...
<body>
    <header class="header">
        <nav class="nav container">
            ...
            <ul class="nav__menu">
                ...
                <li><a href="<?= base_url(); ?>jorge" class="nav__link">Jorge Caraballo</a></li>
                <li><a href="<?= base_url(); ?>laura" class="nav__link active">Laura Aguerrevere</a></li>
            </ul>
                    ...
                    <form class="contact__form" id="contactForm">
                        ...
                        <div class="form__group">
                            ...
                            <select id="subject" name="subject" class="form__input" required>
                                ...
                                <option value="consultoria">Consulta Jurídica</option>
                                <option value="asesoramiento">Asesoramiento Legal</option>
                                <option value="colaboracion">Colaboración Académica</option>
                                <option value="proyecto">Proyecto de Investigación</option>
                                <option value="conferencia">Invitación a Conferencia</option>
                        ...
                        <div class="form__group">
                            ...
                            <textarea id="message" name="message" class="form__textarea" rows="6" required placeholder="Describa su consulta o propuesta de manera detallada..."></textarea>
                        </div>
                ...
                <div class="footer__links">
                    <div class="footer__column">
                        ...
                        <ul>
                            ...
                            <li><a href="<?= base_url(); ?>jorge">Jorge Caraballo</a></li>
                            <li><a href="<?= base_url(); ?>laura">Laura Aguerrevere</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    // Script adicional para el formulario de contacto
            ...
            contactForm.addEventListener('submit', function(e) {
                ...
                if (!name || !email || !subject || !message) {
                    Swal.fire({
                        ...
                        background: getComputedStyle(document.documentElement).getPropertyValue('--color-surface'),
                        color: getComputedStyle(document.documentElement).getPropertyValue('--color-text'),
                        confirmButtonColor: 'var(--color-justipedia)'
                    });
                    return;
                }
                ...
                setTimeout(() => {
                    Swal.fire({
                        ...
                        text: 'Laura Aguerrevere se pondrá en contacto contigo pronto.',
